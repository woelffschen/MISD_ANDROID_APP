...
public class Server implements IServer {
    ...
    public int register(String mailAddress, String lastname, String firstname, String street, int postalCode, String city,
        ...
        SoapObject resultRegister = HelperMethods.executeSessionSoapAction("registerUser", mailAddress, lastname, firstname, street, postalCode, city, unixDateOfBirth, telephoneNumber, (int)gender);
    ...
    public int request(int sessionId, int eventId, int userId) throws Exception {
    ...
    public int create(int sessionId, String userId, int min, int max, String street, int plz, String city,
                                   String comments, char gender, Calendar dateTime, String eo, String name, boolean lactose, boolean gluten,
    ...
    public void delete(int eventId, BigInteger userId) throws Exception {
    ...
    public Event getOneEvent(int eventId ) throws Exception {
        ...
        if(returnCode == 0) {
            ...
            int minAge = Integer.valueOf(resultgetOneEvent.getPrimitivePropertySafelyAsString("min"));
            int maxAge = Integer.valueOf(resultgetOneEvent.getPrimitivePropertySafelyAsString("max"));
            char gender = resultgetOneEvent.getPrimitivePropertySafelyAsString("g").charAt(0);
            String street = resultgetOneEvent.getPrimitivePropertySafelyAsString("street");
            int postalCode = Integer.valueOf(resultgetOneEvent.getPrimitivePropertySafelyAsString("plz"));
            String city = resultgetOneEvent.getPrimitivePropertySafelyAsString("city");
            String description = resultgetOneEvent.getPrimitivePropertySafelyAsString("com");
            int dateOfEvent = Integer.valueOf(resultgetOneEvent.getPrimitivePropertySafelyAsString("dt"));
            String eventOwner = resultgetOneEvent.getPrimitivePropertySafelyAsString("eo");
            String eventName = resultgetOneEvent.getPrimitivePropertySafelyAsString("n");
            boolean lactose = Boolean.valueOf(resultgetOneEvent.getPrimitivePropertySafelyAsString("l"));
            boolean gluten = Boolean.valueOf(resultgetOneEvent.getPrimitivePropertySafelyAsString("gl"));
            boolean fructose = Boolean.valueOf(resultgetOneEvent.getPrimitivePropertySafelyAsString("f"));
            boolean sorbit = Boolean.valueOf(resultgetOneEvent.getPrimitivePropertySafelyAsString("s"));
            boolean vegan = Boolean.valueOf(resultgetOneEvent.getPrimitivePropertySafelyAsString("ve"));
            boolean vegetarian = Boolean.valueOf(resultgetOneEvent.getPrimitivePropertySafelyAsString("veg"));
    ...
    public List<Event> getListOfEvents(int sessionId) throws Exception {
        ...
        if(returnCode == 0) {
            for (int i = 1; i < resultGetListOfEvents.getPropertyCount(); i++) {
                ...
                String street = ""; // ((SoapPrimitive)resultgetOneEvent.getProperty("street")).getValue().toString();
                ...
                Integer dateOfEvent = Integer.valueOf(((SoapPrimitive)resultgetOneEvent.getProperty("eventDateTime")).getValue().toString());
